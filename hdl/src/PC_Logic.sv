...
module PC_Logic( // This is a combinational module, unlike ARM. See the note below.
	input wire [1:0] PCS,	// 00 for non-control, 01 for conditional branch, 10 for jal, 11 for jalr
	input wire [2:0] funct3,	// condition specified in the instruction (eq / ne / lt / ge / ltu / geu)
	input wire [2:0] alu_flags, 	// {eq, lt, ltu}
